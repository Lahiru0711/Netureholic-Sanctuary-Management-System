...
const B1_Inventory = () => {
  ...
  const deleteData = async (id, type) => {
    ...
    if (window.confirm("Do you want to delete !")) {
      await axios.delete(`/Bungalow_1/B1_delete/${id}`);
      await axios
        .get("/Bungalow_1/")
        .then((res) => setData(res?.data))
        .catch((error) => alert(error));
      ...
      <div>
        ...
        >
          <div className=" inline-flex  mx-auto">
            ...
            <div>
              <h1 className=" ml-96 pl-44 text-5xl text-lime-500 font-semibold">
                -Bungalow No.1 Inventory-
              </h1>
            </div>
          </div>
        </Box>
